/*********************************************************************************************************//**
 * @file    IAP/IAP_Text_RAM/Src_IAP/iap_handler.h
 * @version $Rev:: 929          $
...
/* Exported constants --------------------------------------------------------------------------------------*/
#define IAP_FLASH_START    (1024 * 3)
#define IAP_FLASH_END      (1024 * 255)
#define IAP_SRAM_END       (HT_SRAM_BASE + 1024 * 32)

#define IAP_START          (0x00000000)

#define IAP_UPDATE_IAP     (0x0)
#define IAP_UPDATE_AP      (0x1)
