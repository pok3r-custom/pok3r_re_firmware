...
int main(void)
{
  ...
  /* Configure GPIO's AFIO mode as GPTM1 function                                                           */
  AFIO_GPCConfig(AFIO_PIN_0 | AFIO_PIN_1 | AFIO_PIN_2 | AFIO_PIN_3, AFIO_MODE_4);
  ...
  CapInit.Filter = 0x0;
  GPTM_CaptureInit(HT_GPTM1, &CapInit);

  CapInit.Channel = GPTM_CH_1;
  GPTM_CaptureInit(HT_GPTM1, &CapInit);

  CapInit.Channel = GPTM_CH_2;
  GPTM_CaptureInit(HT_GPTM1, &CapInit);

  CapInit.Channel = GPTM_CH_3;
  GPTM_CaptureInit(HT_GPTM1, &CapInit);
  ...
  GPTM_IntConfig(HT_GPTM1, GPTM_INT_CH0CC | GPTM_INT_CH1CC | GPTM_INT_CH2CC |
                           GPTM_INT_CH3CC | GPTM_INT_UEV, ENABLE);
...
/*********************************************************************************************************//**
  ...
  *   - CH0 : frequency 1Hz and duty 25 uS
  *   - CH1 : frequency 1Hz and duty 250 uS
  *   - CH2 : frequency 1Hz and duty 25 mS
  *   - CH3 : frequency 1Hz and duty 950 mS
  *
  ***********************************************************************************************************/
void GPTM0_Configuration(void)
{
  ...
  /* GPTM0 Channel 0 output PWM (frequency 1Hz and duty 25 uS)                                              */
  ...
  /* GPTM0 Channel 1 output PWM (frequency 1Hz and duty 250 uS)                                             */
  OutInit.Channel = GPTM_CH_1;
  OutInit.Compare = TimeBaseInit.CounterReload - 10 + 1;
  GPTM_OutputInit(HT_GPTM0, &OutInit);

  /* GPTM0 Channel 2 output PWM (frequency 1Hz and duty 25 mS)                                              */
  OutInit.Channel = GPTM_CH_2;
  OutInit.Compare = TimeBaseInit.CounterReload - 1000 + 1;
  GPTM_OutputInit(HT_GPTM0, &OutInit);

  /* GPTM0 Channel 3 output PWM (frequency 1Hz and duty 950 mS)                                             */
