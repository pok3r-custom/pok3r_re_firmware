/*********************************************************************************************************//**
 * @file    USBD/Mass_Storage_IAP/Src_IAP/ht32_board_config.h
 * @version $Rev:: 427          $
...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_FLASH_SIZE              (63)
  #define HTCFG_SRAM_SIZE               (16)
#endif

#if defined(USE_HT32F1655_56)
  #define HTCFG_USBPRE_DIV              (CKCU_USBPRE_DIV3)
  #define HTCFG_FLASH_SIZE              (255)
  #define HTCFG_SRAM_SIZE               (32)
#endif
