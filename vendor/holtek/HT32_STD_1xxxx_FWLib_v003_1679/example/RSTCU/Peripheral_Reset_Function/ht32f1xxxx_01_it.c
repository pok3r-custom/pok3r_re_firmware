/*********************************************************************************************************//**
 * @file    RSTCU/Peripheral_Reset_Function/ht32f1xxxx_01_it.c
 * @version $Rev:: 1372         $
...
/*********************************************************************************************************//**
 * @brief   This function handles EXTIn interrupt.
 * @retval  None
 ************************************************************************************************************/
void HTCFG_FUN_BUTTON_EXTI_IRQ(void)
{
  RSTCU_PeripReset_TypeDef RSTCUReset = {{0}};

  /* Clear the specified EXTI channel edge flag                                                             */
  EXTI_ClearEdgeFlag(HTCFG_EXTI_CH);

  /* Generate GPIO peripheral Reset                                                                         */
  HTCFG_RESET_LED(RSTCUReset) = 1;
  RSTCU_PeripReset(RSTCUReset, ENABLE);

  /* After Resetting Port D, LED1 & LED2 are OFF, only LED3 is still flashing                               */
}
