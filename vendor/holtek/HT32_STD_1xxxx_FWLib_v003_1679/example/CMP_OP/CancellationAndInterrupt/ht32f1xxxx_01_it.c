/*********************************************************************************************************//**
 * @file    CMP_OP/CancellationAndInterrupt/ht32f1xxxx_01_it.c
 * @version $Rev:: 1372         $
...
{
  if (CMP_OP_GetIntStatus(HT_CMP_OP0, CMP_OP_INT_FALLING))
  {
    CMP_OP_ClearIntPendingBit(HT_CMP_OP0, CMP_OP_INT_FALLING);
    HT32F_DVB_LEDOff(HT_LED1);
  }

  if (CMP_OP_GetIntStatus(HT_CMP_OP0, CMP_OP_INT_RISING))
  {
    CMP_OP_ClearIntPendingBit(HT_CMP_OP0, CMP_OP_INT_RISING);
