...
This example describes how to configure the GPIO as EXTI Wake Up Event to wake up the system from the Deep Sleep
mode 1. The example also shows the different of WFI and WFE:
...
LED1 is turn on by the ISR of Wake Up interrupt, EVWUP_IRQHandler().
LED2 is turn on by the main loop after system wake up.
