...
a period of 1 ms, and the LEDs flashing frequency is 1 Hz.
 
@par Directory Contents:

- SYSTICK/Period_DownCounting/main.c               Main program
- SYSTICK/Period_DownCounting/ht32f1xxxx_01_it.c   Interrupt handlers
...
The frequency of LEDs flashing is set to 1 Hz by inserting a delay into the 'Delay' function.
