...
The USART_CLK frequency is equal to 72 MHz.
 
The USART baud rate is set to 115200 bps.

USART will print "Hello World!" string 10 times on hyperterminal.

Then USART0 will get character from hyperterminal and show again on the screen (Loopback).

@par Directory Contents:

- USART/HyperTerminal_TxRx/main.c               Main program
- USART/HyperTerminal_TxRx/ht32f1xxxx_01_it.c   Interrupt handlers
