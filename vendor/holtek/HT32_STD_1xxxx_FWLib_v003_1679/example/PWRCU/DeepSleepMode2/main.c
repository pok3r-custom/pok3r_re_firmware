...
int main(void)
{
  ...
  HTCFG_WEAK_UP_BUTTON(CKCUClock)        = 1;
  ...
  GPIO_PullResistorConfig(GPIO_PORT[WAKEUP_BUTTON_GPIO_ID], WAKEUP_BUTTON_GPIO_PIN, GPIO_PR_DISABLE);
  GPIO_DirectionConfig(GPIO_PORT[WAKEUP_BUTTON_GPIO_ID], WAKEUP_BUTTON_GPIO_PIN, GPIO_DIR_IN);
