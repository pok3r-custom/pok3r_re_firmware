...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  DESC_W2B(DESC_CLOCK_FREQUENCY),  // dwClockFrequency    4 the device clock frequency in Hz.(15MHz)
  ...
  0x15, 0x16, 0x05, 0x00,  //30Hz
  0x20, 0xA1, 0x07, 0x00,  //20Hz
  0x2A, 0x2C, 0x0A, 0x00,  //15Hz
  0x40, 0x42, 0x0F, 0x00,  //10Hz
  0x80, 0x84, 0x1E, 0x00,  //5Hz
  0x80, 0x96, 0x98, 0x00,  //1Hz*/
