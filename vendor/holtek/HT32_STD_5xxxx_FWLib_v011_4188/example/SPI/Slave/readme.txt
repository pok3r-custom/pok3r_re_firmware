...
This example shows how to configure SPI as Slave mode. When Key1 is pressed ,Slave has data to be transmitted, 
then it set specify GPIO as low to inform the master begin the transmission until 8 data are received and program 
will display reception data by RS232.
