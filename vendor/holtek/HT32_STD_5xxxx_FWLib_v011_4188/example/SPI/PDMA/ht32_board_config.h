...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_SPI_MASTER_PDMA_TX_CH              (PDMA_CH1)
  #define HTCFG_SPI_MASTER_PDMA_RX_CH              (PDMA_CH0)
  ...
  #define HTCFG_SPI_SLAVE_PDMA_TX_CH               (PDMA_CH5)
  #define HTCFG_SPI_SLAVE_PDMA_RX_CH               (PDMA_CH4)
#endif
  ...
  #define HTCFG_SPI_MASTER_PDMA_TX_CH              (PDMA_CH5)
  #define HTCFG_SPI_MASTER_PDMA_RX_CH              (PDMA_CH4)
  ...
  #define HTCFG_SPI_SLAVE_PDMA_TX_CH               (PDMA_CH1)
  #define HTCFG_SPI_SLAVE_PDMA_RX_CH               (PDMA_CH0)
#endif
  ...
  #define HTCFG_SPI_MASTER_MOSI_AFIO_PIN           (AFIO_PIN_4)
  #define HTCFG_SPI_MASTER_MISO_AFIO_PIN           (AFIO_PIN_5)
  #define HTCFG_SPI_MASTER_PDMA_TX_CH              (PDMA_CH3)
  #define HTCFG_SPI_MASTER_PDMA_RX_CH              (PDMA_CH2)
