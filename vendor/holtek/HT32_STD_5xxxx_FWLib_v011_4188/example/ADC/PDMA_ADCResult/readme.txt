...
This example shows how to use the PDMA to move ADC result from ADC->DR[0] to TM CHnCCR.

The TM CHnO is configured as PWM2 output mode.
The TM MTO is connected to update event.
...
The PDMA channel 0 is configured to move ADC result from ADC->DR[0] to TM CHnCCR.
The ADC cycle end of conversion PDMA request is enabled.

Use TM MTO as ADC trigger source. So the ADC will be trigger periodically.

@par Directory Contents:

- ADC/PDMA_ADCResult/main.c               Main program
- ADC/PDMA_ADCResult/ht32fxxxxx_nn_it.c   Interrupt handlers
