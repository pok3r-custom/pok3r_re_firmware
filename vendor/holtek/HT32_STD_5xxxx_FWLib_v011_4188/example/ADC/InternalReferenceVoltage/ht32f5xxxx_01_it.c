...
void ADC_IRQHandler(void)
{
  ...
  if (ADC_GetIntStatus(HT_ADC, ADC_INT_CYCLE_EOC) == SET)
  {
    ...
    gADC_Result[0] = HT_ADC->DR[0] & 0x0FFF;    //MVDDA Conversion Result
    gADC_Result[1] = HT_ADC->DR[1] & 0x0FFF;    //IVREF Conversion Result
    gADC_Result[2] = HT_ADC->DR[2] & 0x0FFF;    //Potentiometer Conversion Result
  }
}
