/**
@page ADC_EXTITrigger_DiscontinuousMode
...
- Sequence 0 used to convert Channel n1. The conversion time = (1/(CK_AHB / 64)) * 14.
- Sequence 1 used to convert Channel n2. The conversion time = (1/(CK_AHB / 64)) * 14.

The subgroup 1 includes:
- Sequence 2 used to convert Channel n3. The conversion time = (1/(CK_AHB / 64)) * 14.
...
- ADC/EXTITrigger_DiscontinuousMode/ht32fxxxxx_nn_it.c   Interrupt handlers
