/*********************************************************************************************************//**
 * @file    ADC/TM_Trigger_with_Delay/ht32_board_config.h
 * @version $Rev:: 1209         $
...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_PWM_GPIO_ID                 (GPIO_PA)
  #define HTCFG_PWM_AFIO_PIN                (AFIO_PIN_2)
  ...
  #define HTCFG_PWM_GPIO_ID                 (GPIO_PC)
  #define HTCFG_PWM_AFIO_PIN                (AFIO_PIN_8)
  #define HTCFG_PWM_TM_CH                   (TM_CH_2)
#endif
  ...
  #define HTCFG_PWM_GPIO_ID                 (GPIO_PB)
  #define HTCFG_PWM_AFIO_PIN                (AFIO_PIN_5)
  #define HTCFG_PWM_TM_CH                   (TM_CH_2)
#endif
  ...
  #define HTCFG_AD0_GPIO_ID                 (GPIO_PA)
  #define HTCFG_AD0_AFIO_PIN                (AFIO_PIN_6)
  #define HTCFG_AD0_ADC_CH                  (ADC_CH_10)

  #define HTCFG_AD1_GPIO_ID                 (GPIO_PC)
  #define HTCFG_AD1_AFIO_PIN                (AFIO_PIN_4)
  #define HTCFG_AD1_ADC_CH                  (ADC_CH_12)

  #define HTCFG_AD2_GPIO_ID                 (GPIO_PC)
  #define HTCFG_AD2_AFIO_PIN                (AFIO_PIN_5)
  #define HTCFG_AD2_ADC_CH                  (ADC_CH_13)
  ...
  #define HTCFG_AD0_GPIO_ID                 (GPIO_PA)
  #define HTCFG_AD0_AFIO_PIN                (AFIO_PIN_3)
  #define HTCFG_AD0_ADC_CH                  (ADC_CH_3)
  ...
  #define HTCFG_AD0_GPIO_ID                 (GPIO_PA)
  #define HTCFG_AD0_AFIO_PIN                (AFIO_PIN_2)
  #define HTCFG_AD0_ADC_CH                  (ADC_CH_2)
  ...
  #define HTCFG_AD0_GPIO_ID                 (GPIO_PD)
  #define HTCFG_AD0_AFIO_PIN                (AFIO_PIN_4)
  #define HTCFG_AD0_ADC_CH                  (ADC_CH_8)
