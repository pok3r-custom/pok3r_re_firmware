...
int main(void)
{
  ...
  /* Set key table, AES only supports key size of 128 bits.                                                 */
  ...
  /* Encryption                                                                                             */
  if (!AES_CBC_CryptData(HT_AES, AES_DIR_ENCRYPT, u8IntialVector, BUFF_SIZE, u8OrgData, u8EncodeData))
  {
  ...
  /* Decryption                                                                                             */
  if (!AES_CBC_CryptData(HT_AES, AES_DIR_DECRYPT, u8IntialVector, BUFF_SIZE, u8EncodeData, u8DecodeData))
  {
    /* Input length must be a multiple of 16                                                                */
