...
int main(void)
{
  ...
  AES_SetKeyTable(HT_AES, gu8Key, sizeof(gu8Key));

  /* Time Zero                                                                                              */
  BFTM_SetCounter(HT_BFTM0, 0);

  /* Encryption                                                                                             */
  if (!AES_ECB_CryptData(HT_AES, AES_DIR_ENCRYPT, BUFF_SIZE, u8Data, u8ciphertext))
  {
  ...
  /* Display Result                                                                                         */
  {
    ...
    {
      printf("%03d     |0x%02X     |0x%02X        |0x%02X\r\n", i + 1, u8Data[i], u8ciphertext[i], u8plaintext[i]);
    }
    printf("\r\n");
    printf("--------------------------------------\r\n");
