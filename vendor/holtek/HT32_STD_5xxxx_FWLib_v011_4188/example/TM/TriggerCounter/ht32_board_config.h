...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_INPUT_CAPTURE_GPTM_AFIO_PIN               (AFIO_PIN_0)
  #define HTCFG_INPUT_CAPTURE_GPTM_CHANNEL                (TM_CH_0)
#endif
  ...
  #define HTCFG_INPUT_CAPTURE_GPTM_AFIO_PIN               (AFIO_PIN_4)
  #define HTCFG_INPUT_CAPTURE_GPTM_CHANNEL                (TM_CH_0)
#endif
  ...
  #define HTCFG_INPUT_CAPTURE_GPTM_GPIO_ID                (GPIO_PC)
  #define HTCFG_INPUT_CAPTURE_GPTM_AFIO_PIN               (AFIO_PIN_10)
  #define HTCFG_INPUT_CAPTURE_GPTM_CHANNEL                (TM_CH_0)
#endif
