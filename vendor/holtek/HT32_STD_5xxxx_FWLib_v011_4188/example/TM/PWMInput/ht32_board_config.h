...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_INPUT_PWM_GPTM_CHANNEL                (TM_CH_1)
  #define HTCFG_INPUT_PWM_GPTM_IRQn                   (GPTM0_IRQn)
  #define HTCFG_INPUT_PWM_GPTM                        (HT_GPTM0)
  #define HTCFG_INPUT_PWM_GPTM_AFIO_MODE              (AFIO_MODE_4)
  #define HTCFG_INPUT_PWM_GPTM_CLK(CK)                (CK.Bit.GPTM0)
  ...
  #define HTCFG_OUTPUT_PWM_BY_AFIO_MODE               (AFIO_MODE_13)
  ...
  #define HTCFG_INPUT_PWM_GPTM_AFIO_PIN               (AFIO_PIN_5)
  #define HTCFG_INPUT_PWM_GPTM_CHANNEL                (TM_CH_1)
  #define HTCFG_INPUT_PWM_GPTM_IRQn                   (GPTM0_IRQn)
  #define HTCFG_INPUT_PWM_GPTM                        (HT_GPTM0)
  #define HTCFG_INPUT_PWM_GPTM_AFIO_MODE              (AFIO_MODE_4)
  ...
  #define HTCFG_INPUT_PWM_GPTM_GPIO_ID                (GPIO_PC)
  #define HTCFG_INPUT_PWM_GPTM_AFIO_PIN               (AFIO_PIN_11)
  #define HTCFG_INPUT_PWM_GPTM_CHANNEL                (TM_CH_1)
  #define HTCFG_INPUT_PWM_GPTM_IRQn                   (GPTM0_IRQn)
  #define HTCFG_INPUT_PWM_GPTM                        (HT_GPTM0)
  #define HTCFG_INPUT_PWM_GPTM_AFIO_MODE              (AFIO_MODE_4)
