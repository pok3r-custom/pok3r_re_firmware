...
s32 dm9000_init(DM9000_TypeDef *DM9000Info)
{
  ...
  else
  {
    ...
    AFIO_GPCConfig(AFIO_PIN_0 | AFIO_PIN_1 | AFIO_PIN_2 | AFIO_PIN_4 |
...
static void _dm9000_Configuration(void)
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
  AFIO_GPAConfig(AFIO_PIN_14 | AFIO_PIN_15, AFIO_MODE_9);
  AFIO_GPBConfig(AFIO_PIN_0 | AFIO_PIN_1 | AFIO_PIN_2 | AFIO_PIN_3 | AFIO_PIN_4 | AFIO_PIN_5, AFIO_MODE_9);

  /*--------------------------------------------------------------------------------------------------------*/
  /* Configure CS, CMD, IOW, IOR as EBI                                                                     */
  /*--------------------------------------------------------------------------------------------------------*/
  DM9K_CS_AFIOFUN(DM9K_CS_AFIO, DM9K_CS_AFMODE);
  DM9K_CMD_AFIOFUN(DM9K_CMD_AFIO, DM9K_CMD_AFMODE);
  DM9K_WR_AFIOFUN(DM9K_WR_AFIO, DM9K_WR_AFMODE);
  DM9K_RD_AFIOFUN(DM9K_RD_AFIO, DM9K_RD_AFMODE);

  /*--------------------------------------------------------------------------------------------------------*/
  /* Configure RESET as GPIO output High                                                                    */
  /*--------------------------------------------------------------------------------------------------------*/
  DM9K_RESET_AFIOFUN(DM9K_RESET_AFIO, DM9K_RESET_AFMODE);
  ...
  /*--------------------------------------------------------------------------------------------------------*/
  DM9K_INT_AFIOFUN(DM9K_INT_AFIO, AFIO_MODE_DEFAULT);
 ...
 * @param uMediaMode: Media mode.
     This parameter can be any combination of the following values:
       ...
       @arg DM9000_10MHD: 10MHz, Half duplex
       @arg DM9000_10MFD: 10MHz, Full duplex
       @arg DM9000_100MHD: 100MHz, Half duplex
       @arg DM9000_100MFD: 100MHz, Full duplex
 * @retval None
 ************************************************************************************************************/
static void phy_mode_set(u32 uMediaMode)
{
