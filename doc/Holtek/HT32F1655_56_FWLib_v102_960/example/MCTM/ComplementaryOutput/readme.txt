...
inserted and break function. Since the system clock is 72MHz and MCTM prescaler is equal to 0, the MCTM
counter clock is 72MHz.

- MCTM frequency = MCTM counter clock / (MCTM_Reload + 1) = 2KHz.
