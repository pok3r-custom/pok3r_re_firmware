/**
 @page GPTM_InputCapture

 @verbatim
 * @file    GPTM/InputCapture/readme.txt
 * @version V1.00
 * @date    2014-06-30
...
The GPTM1_PCLK frequency is set to 72 MHz, the Prescaler is 0 and so the GPTM1 counter clock is 72 MHz. GPTM1
is configured as Input Capture Mode: the external signals are connected to GPTM1 Channel1, channel3 as input
pin. The GPTM1 Channel Capture interrupts and Update Event interrupt are enabled.
...
- GPTM/InputCapture/ht32fxxxx_it.c           Interrupt handlers
