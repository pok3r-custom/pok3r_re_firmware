...
//__ALIGN4 static u8 gOutputDataBuffer[_EP4LEN];
__ALIGN4 vu8 gOutputDataBuffer[8][_EP4LEN];

vu32 uBufferIndex = 0;

vu8 gIsAudioDataIn = 0;
extern u32 USBBuf[2][_EP4LEN];

extern void _USBD_CopyMemory(u32 *pFrom, u32 *pTo, u32 len);

vu8 UAC_bMuteControl      = 0x00;           /* Power Mode */
static u16 UAC_sVolumeControl   = 0x0000;
static u8 UAC_bBassControl      = 0x0000;
/* Private macro -------------------------------------------------------------------------------------------*/
...
{ 
  extern vu8 AltBuf;
  extern __ALIGN4 u32 TxBuf[2][48];
  /* Read Receive data.                                                                                     */
