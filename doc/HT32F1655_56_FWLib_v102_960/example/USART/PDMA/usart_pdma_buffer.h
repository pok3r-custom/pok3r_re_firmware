...
#define GetRxBufferWriteIndex() (((HT_PDMA->PDMACH2.CADR & 0xFFFF) - ((u32)RxBuffer & 0xFFFF)) % RX_BUFFER_SIZE)

#define IsRxBufferEmpty() (GetRxBufferWriteIndex() == RxBufferReadIndex)
#define IsRxBufferFull() ((((HT_PDMA->PDMACH2.CADR & 0xFFFF) - ((u32)RxBuffer & 0xFFFF)) + 1) % RX_BUFFER_SIZE \
                           == RxBufferReadIndex )
