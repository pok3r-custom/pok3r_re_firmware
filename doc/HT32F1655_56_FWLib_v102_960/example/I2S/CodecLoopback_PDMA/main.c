...
int main(void)
{
  ...
  I2S_InitStructure.I2S_X_Div = 6;            // MCLK = 72MHz * 6/211 = 2.047MHz (256 x 8kHz)
  I2S_InitStructure.I2S_Y_Div = 211;
  I2S_InitStructure.I2S_N_Div = 256/(2 * 16);   // BCLK = 2.047MHz/8 = 255.924KHz (32 x 8kHz)
#else
  I2S_InitStructure.I2S_X_Div = 37;           // MCLK = 72MHz * 37/236 = 11.288MHz (256 x 44.1kHz)
  I2S_InitStructure.I2S_Y_Div = 236;
  I2S_InitStructure.I2S_N_Div = 256/(2 * 16);   // BCLK = 11.288MHz/8 = 1411.016KHz (32 x 44.1kHz)
#endif
  ...
  PDMA_IntConig(PDMA_CH2, (PDMA_INT_GE | PDMA_INT_TC | PDMA_INT_HT), ENABLE);
