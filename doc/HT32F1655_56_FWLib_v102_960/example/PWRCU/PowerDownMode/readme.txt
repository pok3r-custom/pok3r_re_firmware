...
The system clock is set to 72 MHz by the external high speed oscillator(HSE),
...
Two leds LED1, LED2 and LED3 are used to monitor the system state as following:
