...
int main(void)
{
  ...
  PDMA_IntConig(PDMA_CH1, PDMA_INT_GE | PDMA_INT_TC, ENABLE);
  PDMA_IntConig(PDMA_CH0, PDMA_INT_GE | PDMA_INT_TC, ENABLE);

  /* Enable SPI1 Tx, Rx GE & TC interrupt                                                                   */
  PDMA_IntConig(PDMA_CH5, PDMA_INT_GE | PDMA_INT_TC, ENABLE);
  PDMA_IntConig(PDMA_CH4, PDMA_INT_GE | PDMA_INT_TC, ENABLE);
