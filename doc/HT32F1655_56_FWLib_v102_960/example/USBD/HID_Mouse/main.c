...
void GPIO_Configuration(void)
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
  GPIO_DirectionConfig(HT_GPIOE, GPIO_PIN_4 | GPIO_PIN_5 |GPIO_PIN_6, GPIO_DIR_IN);
  GPIO_InputConfig(HT_GPIOE, GPIO_PIN_4 | GPIO_PIN_5 |GPIO_PIN_6, ENABLE);
  GPIO_DirectionConfig(HT_GPIOC, GPIO_PIN_3, GPIO_DIR_IN);
  GPIO_InputConfig(HT_GPIOC, GPIO_PIN_3, ENABLE);
  GPIO_DirectionConfig(HT_GPIOD, GPIO_PIN_6, GPIO_DIR_IN);
  GPIO_InputConfig(HT_GPIOD, GPIO_PIN_6, ENABLE);

  GPIO_DirectionConfig(HT_GPIOE, GPIO_PIN_1 | GPIO_PIN_2, GPIO_DIR_IN);
  GPIO_InputConfig(HT_GPIOE, GPIO_PIN_1 | GPIO_PIN_2, ENABLE);
}
